...
→ Chrome フラグが有効になっていない。事前アナウンスの手順 2 を再確認させる。
一度フラグを設定しても **Chrome を再起動**しないと反映されない点も要注意。
...
1. **予備 PC を貸与**（環境設定済みのバックアップ機）
2. サンプル画像で動作確認だけ済ませて**他章に誘導**
3. 「持ち帰り課題」として README を渡し、後日環境を整えてもらう

## 📞 エスカレーション

- 会場運営 Slack / Discord: **`#io-extended-tokyo-2026-staff`**（当日運営から案内）
- 講師連絡先: 当日運営 Slack で共有
